...
- **[DyNeuSR Notebooks.](https://braindynamicslab.github.io/dyneusr-notebooks/)**&nbsp;A collection of Jupyter notebook tutorials based on [DyNeuSR](https://braindynamicslab.github.io/dyneusr/). The tutorials introduce DyNeuSR's Python API and highlight different aspects of analysis and visualization, including a simple trefoil knot demo and examples using real fMRI data from the Haxby 2001 visual decoding experiment.
