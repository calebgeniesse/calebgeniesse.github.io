...
- **[DyNeuSR Notebooks.](https://braindynamicslab.github.io/dyneusr-notebooks/)**&nbsp;A collection of Jupyter notebook tutorials based on [DyNeuSR](https://braindynamicslab.github.io/dyneusr/). The tutorials introduce DyNeuSR's API and highlight different aspects of analysis and visualization, including a synthetic trefoil knot example and real fMRI data from the Haxby 2001 visual decoding experiment.
